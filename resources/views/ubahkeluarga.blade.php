...
@section('title', "Ubah Anggota Keluarga / Tanggungan / Waris")

@section('breadcrumb')
<p class="text-muted" style="font-size: 14px;">
    <a href="{{ url('/peserta') }}" style="text-decoration:none; color:#555;">Peserta</a> /
    <a href="{{ url('/peserta/keluarga') }}" style="text-decoration:none; color:#555;">Ahli Waris</a> /
    <a href="{{ url('/peserta/keluarga/ubahkeluarga') }}" style="text-decoration:none; color:#2994A4;">Ubah Ahli Waris</a>
</p>
@endsection
...
<div class="card">
    <div class="card-body">
        ...
        {{-- Form Tambah --}}
        <form action="/peserta/keluarga/ubahkeluarga" method="POST" style="max-width: 700px; margin:auto;">
            @csrf
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="/peserta/keluarga" class="btn" style="background-color:#6c757d; color:white;">
                    Kembali
                </a>
